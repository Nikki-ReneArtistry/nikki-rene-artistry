...
export const artworks: Artwork[] = [
  ...
  { id: "awakening-the-flames", title: "Awakening the Flames", description: defaultDescription("Awakening the Flames"), image: placeholderImg, price: 75, size: '12×16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQ8wQgbO6ex77jaPY2oE2G" },
  ...
  { id: "urban-echoes", title: "Urban Echoes", description: defaultDescription("Urban Echoes"), image: placeholderImg, price: 175, size: '6×40"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/aFacN63p26exbnz3nw2oE2P" },
  ...
  { id: "ebb-and-flow", title: "Ebb and Flow", description: defaultDescription("Ebb and Flow"), image: placeholderImg, price: 400, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/6oUfZibVy32lezL9LU2oE2R" },
  { id: "tidal-embrace", title: "Tidal Embrace", description: defaultDescription("Tidal Embrace"), image: placeholderImg, price: 225, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/7sY6oI4t60Ud9fr8HQ2oE2S" },
  ...
  { id: "time-flies", title: "Time Flies", description: defaultDescription("Time Flies"), image: placeholderImg, price: 400, size: '20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/aFa7sMf7KdGZ3V73nw2oE2U" },
  ...
  { id: "circles-of-life", title: "Circles of Life", description: defaultDescription("Circles of Life"), image: placeholderImg, price: 200, size: '16×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQ5kEcZCauN3V74rA2oE2W" },
  { id: "shards-of-life", title: "Shards of Life", description: defaultDescription("Shards of Life"), image: placeholderImg, price: 200, size: '16×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/6oU4gAcZCfP7bnz6zI2oE2X" },
  { id: "gilded-manifestation", title: "Gilded Manifestation", description: defaultDescription("Gilded Manifestation"), image: placeholderImg, price: 400, size: '21×27"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQ9AUbVy9qJ8bn6zI2oE2Y" },
  ...
  { id: "silent-reverie", title: "Silent Reverie", description: defaultDescription("Silent Reverie"), image: placeholderImg, price: 150, size: '10×40"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/eVq8wQ7FicCVcrD6zI2oE30" },
  ...
  { id: "sunflower-goddess", title: "Sunflower Goddess", description: defaultDescription("Sunflower Goddess"), image: placeholderImg, price: 500, size: '24×30"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/3cI5kE4t68mFbnzgai2oE33" },
  { id: "redeemed", title: "Redeemed", description: defaultDescription("Redeemed"), image: placeholderImg, price: 95, size: '9×14"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gM3cwbVy0Ud9fr6zI2oE34" },
  { id: "full-circle", title: "Full Circle", description: defaultDescription("Full Circle"), image: placeholderImg, price: 300, size: '', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gMcN6aRu1Yh1MZ0bk2oE35" },
  { id: "bourbon-street-beats", title: "Bourbon Street Beats", description: defaultDescription("Bourbon Street Beats"), image: placeholderImg, price: 600, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/00wfZibVyauNcrDaPY2oE36" },
  { id: "lunar-longings", title: "Lunar Longings", description: defaultDescription("Lunar Longings"), image: placeholderImg, price: 350, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/3cI5kE2kY8mF9frf6e2oE37" },
  { id: "natures-adornment", title: "Nature's Adornment", description: defaultDescription("Nature's Adornment"), image: placeholderImg, price: 700, size: '24×36"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/14AfZicZCfP79fr9LU2oE38" },
  { id: "mystic-orbs", title: "Mystic Orbs", description: defaultDescription("Mystic Orbs"), image: placeholderImg, price: 400, size: '24×48"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/bJe7sM2kY0UdfDP0bk2oE39" },
  ...
  { id: "echoes-of-the-tropics", title: "Echoes of the Tropics", description: defaultDescription("Echoes of the Tropics"), image: placeholderImg, price: 800, size: '38×48"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6dRabVyauN8bn5vE2oE3d" },
];

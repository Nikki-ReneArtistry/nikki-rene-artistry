...
export const artworks: Artwork[] = [
  ...
  { id: "natures-muse", title: "Nature's Muse", description: defaultDescription("Nature's Muse"), image: aquaticMuseImg.url, price: 300, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/00w6oIe3GcCVdvHf6e2oE2T" },

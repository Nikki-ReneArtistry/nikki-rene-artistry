...
export const artworks: Artwork[] = [
  ...
  { id: "gilded-manifestation", title: "Gilded Manifestation", description: defaultDescription("Gilded Manifestation"), image: gildedBloomsImg.url, price: 400, size: '21×27"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQ9AUbVy9qJ8bn6zI2oE2Y" },

...
export const artworks: Artwork[] = [
  ...
  { id: "resilience", title: "Resilience", description: defaultDescription("Resilience"), image: gildedAscensionImg.url, price: 175, size: '16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gM4gAbVy0Ud0IV8HQ2oE2h" },

...
export const artworks: Artwork[] = [
  ...
  { id: "blue-fiery", title: "Blue Fiery", description: defaultDescription("Blue Fiery"), image: tidalConvergenceUploadImg.url, price: 175, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/bJe5kE8Jm1Yhajv4rA2oE2l" },
  { id: "gaea-rising", title: "Dreamy Floral", description: defaultDescription("Dreamy Floral"), image: tidalGardenUploadImg.url, price: 95, size: '11×14"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6fZif7K1Yh8bn5vE2oE2m" },
  ...
  { id: "autumns-grace", title: "Autumn's Grace", description: defaultDescription("Autumn's Grace"), image: featheredGraceImg.url, price: 500, size: '24×18"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/cNi28scZC9qJ1MZf6e2oE2q" },
  ...
  { id: "ebb-and-flow", title: "Ebb and Flow", description: defaultDescription("Ebb and Flow"), image: ebbAndFlowImg.url, price: 275, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/6oUfZibVy32lezL9LU2oE2R" },
  ...
  { id: "frozen-whisper", title: "Frozen Whisper", description: defaultDescription("Frozen Whisper"), image: tearsFrozenUploadImg.url, price: 275, size: '16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gM3cw9Nq0Udajv5vE2oE2V" },
  ...
  { id: "gilded-manifestation", title: "Gilded Manifestation", description: defaultDescription("Gilded Manifestation"), image: gildedManifestationImg.url, price: 300, size: '21×27"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQ9AUbVy9qJ8bn6zI2oE2Y" },
  ...
  { id: "natures-adornment", title: "She Remembered Who She Was", description: defaultDescription("She Remembered Who She Was"), image: adornmentImg.url, price: 500, size: '36×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/14AfZicZCfP79fr9LU2oE38" },
  { id: "mystic-orbs", title: "Mystic Orbs", description: defaultDescription("Mystic Orbs"), image: celestialBloomsImg.url, price: 95, size: '24×48"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/bJe7sM2kY0UdfDP0bk2oE39" },
  ...
  { id: "echoes-of-the-tropics", title: "Echoes of the Tropics", description: defaultDescription("Echoes of the Tropics"), image: art40Img, price: 800, size: '38×48"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6dRabVyauN8bn5vE2oE3d" },

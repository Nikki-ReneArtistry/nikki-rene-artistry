...
import celestialBloomsImg from "@/assets/celestial-blooms.jpg.asset.json";
import gildedBloomImg from "@/assets/gilded-bloom.jpg.asset.json";
import elaraUploadImg from "@/assets/elara-upload.jpg.asset.json";
import gildedDepthsImg from "@/assets/gilded-depths.jpg.asset.json";
import gildedHoursImg from "@/assets/gilded-hours.jpg.asset.json";
import gildedTimepieceImg from "@/assets/gilded-timepiece.jpg.asset.json";
import crownedResilienceImg from "@/assets/crowned-resilience.jpg.asset.json";
import aquaticMuseImg from "@/assets/aquatic-muse.jpg.asset.json";
import crimsonFairyUploadImg from "@/assets/crimson-fairy-upload.jpg.asset.json";
import heartFallenImg from "@/assets/heart-fallen.jpg.asset.json";
import amazeUploadImg from "@/assets/amaze-upload.jpg.asset.json";
import burstMysticalUploadImg from "@/assets/burst-mystical.jpg.asset.json";
import echoesAncientUploadImg from "@/assets/echoes-ancient.jpg.asset.json";
import etherealFusionUploadImg from "@/assets/ethereal-fusion-upload.jpg.asset.json";
import beyondTheMountainsUploadImg from "@/assets/beyond-the-mountains-upload.jpg.asset.json";
import goldenWhispersUploadImg from "@/assets/golden-whispers-upload.jpg.asset.json";
import gildedFoliageImg from "@/assets/gilded-foliage.jpg.asset.json";
...
import mochaUploadImg from "@/assets/mocha-upload.jpg.asset.json";
import latteUploadImg from "@/assets/latte-upload.jpg.asset.json";
import midnightReverieUploadImg from "@/assets/midnight-reverie-upload.jpg.asset.json";
import intricateThoughtsUploadImg from "@/assets/intricate-thoughts-upload.jpg.asset.json";
import plumageDreamsImg from "@/assets/plumage-dreams.jpg.asset.json";
import moonRippleImg from "@/assets/moon-ripple.jpg.asset.json";
import moonlitBotanicalImg from "@/assets/moonlit-botanical.jpg.asset.json";
...
export const artworks: Artwork[] = [
  ...
  },
  {
    ...
    image: goldenWhispersUploadImg.url,
    price: 125,
    size: '10"',
    medium: "Mixed Media",
    year: 2024,
  ...
  },
  {
    ...
    image: burstMysticalUploadImg.url,
    price: 60,
    size: '10"',
    medium: "Mixed Media",
    year: 2024,
  ...
  },
  {
    ...
    image: echoesAncientUploadImg.url,
    price: 85,
    size: '10"',
    medium: "Mixed Media",
    year: 2024,
  ...
  },
  {
    ...
    image: etherealFusionUploadImg.url,
    price: 75,
    size: '10"',
    medium: "Mixed Media",
    year: 2024,
  ...
  },
  {
    ...
    image: beyondTheMountainsUploadImg.url,
    price: 75,
    size: '10"',
    medium: "Mixed Media",
    year: 2024,
  ...
  { id: "whispering-elegance", title: "Whispering Elegance", description: defaultDescription("Whispering Elegance"), image: whisperingEleganceUploadImg.url, price: 145, size: '14"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/eVq9AU2kY9qJ8bn7DM2oE1S" },
  { id: "whispers-of-savanna", title: "Whispers of Savanna", description: defaultDescription("Whispers of Savanna"), image: serengetiDuskUploadImg.url, price: 350, size: '16×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/00w3cw1gU7iB9fr3nw2oE1T" },
  ...
  { id: "aqua-wave-clock", title: "Aqua Wave Clock", description: defaultDescription("Aqua Wave Clock"), image: tidalRhythmUploadImg.url, price: 70, size: '10"', medium: "Mixed Media Clock", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/3cIcN64t6cCV4Zb1fo2oE1W" },
  { id: "pink-burst-clock", title: "Pink Burst Clock", description: defaultDescription("Pink Burst Clock"), image: roseEternalUploadImg.url, price: 70, size: '10"', medium: "Mixed Media Clock", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/eVqdRa6Be0Ud1MZ9LU2oE1X" },
  ...
  { id: "blue-burst-clock", title: "Blue Burst Clock", description: defaultDescription("Blue Burst Clock"), image: temporalBurstUploadImg.url, price: 70, size: '10"', medium: "Mixed Media Clock", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6eVe8Jm1Yh0IVaPY2oE20" },
  { id: "under-the-earth-clock", title: "Under the Earth Clock", description: defaultDescription("Under the Earth Clock"), image: timelessStrataUploadImg.url, price: 70, size: '10"', medium: "Mixed Media Clock", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/cNi28s7Fi9qJezLgai2oE21" },
  ...
  { id: "emerald-symphony", title: "Emerald Symphony", description: defaultDescription("Emerald Symphony"), image: umbrellaStormUploadImg.url, price: 200, size: '18×36"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/3cIeVecZC8mFbnz2js2oE23" },
  ...
  { id: "lighthouse-vigil", title: "Lighthouse Vigil", description: defaultDescription("Lighthouse Vigil"), image: lighthouseVigilImg.url, price: 125, size: '14"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike" },
  ...
  { id: "siren", title: "Siren", description: defaultDescription("Siren"), image: sirensGardenUploadImg.url, price: 175, size: '16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/8x200k4t67iB0IVbU22oE2g" },
  { id: "resilience", title: "Resilience", description: defaultDescription("Resilience"), image: resilienceUploadImg.url, price: 175, size: '16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gM4gAbVy0Ud0IV8HQ2oE2h" },
  { id: "skys-dance", title: "Sky's Dance", description: defaultDescription("Sky's Dance"), image: cranesAscendingImg.url, price: 300, size: '10×30"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQ8wQaRueL3gHT5vE2oE2i" },
  { id: "silent-calm", title: "Silent Calm", description: defaultDescription("Silent Calm"), image: patternedBloomsImg.url, price: 165, size: '14×16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/14A9AU3p2auNezLgai2oE2j" },
  { id: "serenade-of-swallows", title: "Serenade of Swallows", description: defaultDescription("Serenade of Swallows"), image: serenadeOfSwallowsUploadImg.url, price: 130, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/aFabJ23p2fP777jgai2oE2k" },
  { id: "blue-fiery", title: "Blue Fiery", description: defaultDescription("Blue Fiery"), image: tidalConvergenceUploadImg.url, price: 450, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/bJe5kE8Jm1Yhajv4rA2oE2l" },
  { id: "gaea-rising", title: "Gaea Rising", description: defaultDescription("Gaea Rising"), image: tidalGardenUploadImg.url, price: 375, size: '11×14"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6fZif7K1Yh8bn5vE2oE2m" },
  { id: "cosmic-night", title: "Cosmic Night", description: defaultDescription("Cosmic Night"), image: cosmicNightImg.url, price: 95, size: '16×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/7sY28s6Be9qJfDP5vE2oE2n" },
  { id: "copper-fields", title: "Copper Fields", description: defaultDescription("Copper Fields"), image: copperFieldsImg.url, price: 400, size: '20×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/00w5kEbVy1YhgHTe2a2oE2o" },
  { id: "rippled-whispers", title: "Rippled Whispers", description: defaultDescription("Rippled Whispers"), image: rippledWhispersUploadImg.url, price: 300, size: '24×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/3cI6oI8Jm46p9fre2a2oE2p" },
  { id: "autumns-grace", title: "Autumn's Grace", description: defaultDescription("Autumn's Grace"), image: featheredGraceImg.url, price: 500, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/cNi28scZC9qJ1MZf6e2oE2q" },
  { id: "enigma-unveiled", title: "Enigma Unveiled", description: defaultDescription("Enigma Unveiled"), image: enigmaUnveiledImg.url, price: 350, size: '16×12"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/5kQcN65xa9qJgHT4rA2oE2r" },
  { id: "be-different", title: "Be Different", description: defaultDescription("Be Different"), image: beDifferentImg.url, price: 150, size: '16×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/8x200k0cQeL3crD5vE2oE2s" },
  ...
  { id: "winters-silent-tears", title: "Winter's Silent Tears", description: defaultDescription("Winter's Silent Tears"), image: silentSnowfallUploadImg.url, price: 300, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/cNi7sMcZC32l63faPY2oE2w" },
  ...
  { id: "latte", title: "Latte", description: defaultDescription("Latte"), image: latteUploadImg.url, price: 55, size: '10×10"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/cNi00k1gU8mFcrDbU22oE2D" },
  { id: "mocha", title: "Mocha", description: defaultDescription("Mocha"), image: mochaUploadImg.url, price: 55, size: '10×10"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/28E9AU0cQ7iB4Zbe2a2oE2E" },
  { id: "crimson-flow", title: "Crimson Flow", description: defaultDescription("Crimson Flow"), image: crimsonFlowImg.url, price: 150, size: '16×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/6oUeVe9Nq9qJdvH2js2oE2F" },
  ...
  { id: "molten-lava", title: "Molten Lava", description: defaultDescription("Molten Lava"), image: lavaMoltenUploadImg.url, price: 25, size: '4×12"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/bJedRa5xa46pajv6zI2oE2H" },
  { id: "red-river", title: "Red River", description: defaultDescription("Red River"), image: redRiverUploadImg.url, price: 25, size: '4×12"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gMaEY2kYgTbajvgai2oE2I" },
  { id: "fever-flow", title: "Fever Flow", description: defaultDescription("Fever Flow"), image: serpentineDepthsUploadImg.url, price: 50, size: '5×5"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/cNi5kE9NqdGZ77j8HQ2oE2J" },
  { id: "the-glance", title: "The Glance", description: defaultDescription("The Glance"), image: silhouetteMystiqueUploadImg.url, price: 200, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/dRmeVegbO7iB63f8HQ2oE2K" },
  { id: "namaste", title: "Namaste", description: defaultDescription("Namaste"), image: namasteUploadImg.url, price: 123, size: '12×16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/6oUbJ20cQ5at63fcY62oE2L" },
  { id: "mystic-moon", title: "Mystic Moon", description: defaultDescription("Mystic Moon"), image: birchMoonRisingImg.url, price: 175, size: '16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/aFafZi9Nq32l2R38HQ2oE2M" },
  { id: "mystic-river", title: "Mystic River", description: defaultDescription("Mystic River"), image: riverMysticUploadImg.url, price: 250, size: '12×36"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6bJ2cZC6ex9fr2js2oE2N" },
  { id: "journey", title: "Journey", description: defaultDescription("Journey"), image: journeyUploadImg.url, price: 125, size: '12×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/9B6eVe4t6dGZgHT3nw2oE2O" },
  ...
  { id: "tropical-dreamscape", title: "Tropical Dreamscape", description: defaultDescription("Tropical Dreamscape"), image: tropicalDreamscapeUploadImg.url, price: 150, size: '18×24"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/8x28wQ9Nq46p0IV1fo2oE2Q" },
  ...
  { id: "tidal-embrace", title: "Tidal Embrace", description: defaultDescription("Tidal Embrace"), image: tidalEmbraceUploadImg.url, price: 225, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/7sY6oI4t60Ud9fr8HQ2oE2S" },
  { id: "natures-muse", title: "Nature's Muse", description: defaultDescription("Nature's Muse"), image: naturesMuseUploadImg.url, price: 300, size: '20×20"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/00w6oIe3GcCVdvHf6e2oE2T" },
  ...
  { id: "frozen-whisper", title: "Frozen Whisper", description: defaultDescription("Frozen Whisper"), image: tearsFrozenUploadImg.url, price: 150, size: '16"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/4gM3cw9Nq0Udajv5vE2oE2V" },
  ...
  { id: "silent-reverie", title: "Silent Reverie", description: defaultDescription("Silent Reverie"), image: steampunkReverieUploadImg.url, price: 150, size: '10×40"', medium: "Mixed Media", year: 2024, available: true, collection: "No Two Alike", paymentLink: "https://buy.stripe.com/eVq8wQ7FicCVcrD6zI2oE30" },
